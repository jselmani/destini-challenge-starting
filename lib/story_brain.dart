...
class StoryBrain {
  ...
  String getStory() => _storyData[_storyNum].getTitle();
  String getFirstChoice() => _storyData[_storyNum].getChoice1();
  String getSecondChoice() => _storyData[_storyNum].getChoice2();
  void restart() => _storyNum = 0;
  bool buttonShouldBeVisible() =>
      _storyNum == 0 || _storyNum == 1 || _storyNum == 2;
